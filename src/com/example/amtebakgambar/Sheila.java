...
public class Sheila extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_sheila);
  	...
  	if(jawabanUser.equals(jawabanBenar)){
  		...
  		Intent trans = new Intent(getApplicationContext(),Sobat.class);
  		startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.sheila, menu);
		return true;
	}
