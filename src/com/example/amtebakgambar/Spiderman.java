...
public class Spiderman extends Activity {
	EditText jawaban;
	...
	protected void onCreate(Bundle savedInstanceState) {
  	...
  	if(jawabanUser.equals(jawabanBenar)){
  		...
  		Intent trans = new Intent(getApplicationContext(),TebakHuruf.class);
  		startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.spiderman, menu);
		return true;
	}
