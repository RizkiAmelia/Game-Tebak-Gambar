...
public class Tongair extends Activity {
	EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tongair);
  	...
  	if(jawabanUser.equals(jawabanBenar)){
  		...
  		Intent trans = new Intent(getApplicationContext(),UkuranMata.class);
  		startActivity(trans);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tongair, menu);
		return true;
	}
